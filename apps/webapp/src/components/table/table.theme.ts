...
export const table = tv({
  slots: {
    ...
    tableContainer:
      'table-auto overflow-scroll shadow ring-1 ring-black ring-opacity-5 rounded-2xl mt-4',
    tableRoot: 'min-w-full text-left border border-neutral-lightest-gray overflow-x-auto',
  },
});
